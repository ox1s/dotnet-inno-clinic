...
### US-63 Get notification about appointment

_As a PATIENT_
_I want to get notifications_
_so as I can get a reminder about my appointment_
...
| ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **#** | **Description**                                                                                                                                           |
| AC-1  | Given it is the day before an appointment<br><br>Then the system should send a notification in the form of an email sent to the patient’s email address   |
| AC-2  | The notification must include the following appointment details:<br><br>- patient’s full name, <br>- date<br>- time <br>- service<br>- doctor’s full name |

### US-64 Create an appointment by admin

_As a RECEPTIONIST_

_I want to create an appointment for patient_

_so as I can create an appointment for patient that wants to make it by phone_
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **#** | **Description**                                                                                                                                                                                                                                                                                                                                                                 |
| AC-1  | When User clicks the button “Create an appointment”<br><br>Then the modal window/page must be displayed                                                                                                                                                                                                                                                                         |
| AC-2  | The modal window must contain the following fields:<br><br>- patient - combobox<br>- specialization - combobox<br>- doctor - combobox<br>- service - combobox<br>- office - dropdown<br>- date - datepicker<br>- time slots - table with slots<br><br>And the following buttons:<br><br>- button “Create patient”<br>- button “Confirm”<br>- "x" button in the top right corner |
| AC-3  | Given all the fields are completed<br><br>When a User clicks button “Confirm”<br><br>Then the appointment is added in database                                                                                                                                                                                                                                                  |
| AC-4  | Given at least one of the fields is empty<br><br>Or at least one of the fields is invalid<br><br>Then the button “Confirm” is disabled                                                                                                                                                                                                                                          |
| AC-5  | When a User clicks "x" button in the top right corner<br><br>Then a dialog window “Do you really want to exit? Appointment will not be saved.” is displayed                                                                                                                                                                                                                     |
| AC-6  | The dialog window must contain the following buttons:<br><br>- “Yes” button<br>- “No” button                                                                                                                                                                                                                                                                                    |
| AC-7  | When the User clicks “Yes” button <br><br>Then the dialog window is closed<br><br>And the modal window of creation is closed                                                                                                                                                                                                                                                    |
| AC-8  | When the User clicks button “No”<br><br>Then the dialog window is closed<br><br>And the modal window of creation has to be displayed with already entered fields                                                                                                                                                                                                                |
| AC-9  | Given Specialization and Service fields are completed<br><br>Then Date and Time Slots fields get enabled                                                                                                                                                                                                                                                                        |
| AC-10 | List of doctors contains only doctors with “At work” status                                                                                                                                                                                                                                                                                                                     |
| AC-11 | List of offices contains only offices with “Active” status                                                                                                                                                                                                                                                                                                                      |
| AC-12 | List of specializations contains only specializations with “Active” status                                                                                                                                                                                                                                                                                                      |
| AC-13 | List of services contains only services with “Active” status                                                                                                                                                                                                                                                                                                                    |
...
| ----- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **#** | **Field name** | **Description**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| F-1   | Patient        | **Required:** yes<br><br>**Type:** combobox<br><br>**Default value:** empty<br><br>**Behaviour:** <br><br>- When the User starts typing in the patient's name Or the User clicks on the patient fieldThen the System displays the filtered result (if available) of patients in the dropdown<br>- When the User selects the patient from drop-down listThen the System should fill the patient field with this patient <br>- Given entered patient name doesn’t existAnd the field loses focusThen an error message of a invalid value is shown to a User “Invalid patient name”<br>- Given the patient field is empty And the field loses focusThen the border of the field becomes red And an error message of a missing value is shown to a User “Please, choose the patient”                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| F-2   | Specialization | **Required:** yes<br><br>**Type:** combobox<br><br>**Default value:** empty<br><br>**Behaviour:** <br><br>- When the User starts typing in a specialization title Then the System displays the filtered list of specializations in the dropdown<br>- When the User selects the specialization from drop-down listThen the System should fill the specialization field with this specialization<br>- Given entered specialization name doesn’t existAnd the field loses focusThen an error message of a invalid value is shown to a User “Invalid specialization name”<br>- Given doctor field is completedThen specialization field has to be filled with doctor’s specialization<br>- Given service field is completedThen specialization field has to be filled according to service’s specialization<br>- Given office field is completedThen drop-down list must contain specializations according to the specializations of doctors from the office <br>- Given the specialization field is empty And the field loses focusThen the border of the field becomes red And an error message of a missing value is shown to a User “Please, choose the specialization”                                                                                                                                                                                                                                                   |
| F-3   | Doctor         | **Required:** yes<br><br>**Type:** combobox<br><br>**Default value:** empty<br><br>**Behaviour:** <br><br>- When the User starts typing in the doctor's name Or the User clicks on the doctor fieldThen the System displays the filtered result (if available) of doctors in the dropdown<br>- When the User selects the doctor from drop-down listThen the System should fill the doctor field with this doctor<br>- Given entered doctor name doesn’t existAnd the field loses focusThen an error message of a invalid value is shown to a User “Invalid doctor name”<br>- Given specialization field is completedThen drop-down list must contain doctors according to the specialization<br>- Given service field is completedThen drop-down list must contain doctors according to the services<br>- Given office field is completedThen drop-down list must contain doctors according to the the office <br>- Given the doctor field is emptyAnd time and date are completedThen drop-down list must contain doctors according to the selected time and date<br>- Given the doctor field is emptyAnd time and date are completedAnd only 1 doctor is free at this timeThen doctor field is completed with free doctor<br>- Given the doctor field is empty And the field loses focusThen the border of the field becomes red And an error message of a missing value is shown to a User “Please, choose the doctor” |
| F-4   | Service        | **Required:** yes<br><br>**Type:** combobox<br><br>**Default value:** empty<br><br>**Behaviour:** <br><br>- When a User enters service nameThen the drop-down list of services according to entered name is displayed<br>- When the User selects the service from drop-down listThen the System should fill the service field with this service<br>- Given entered service name doesn’t existAnd the field loses focusThen an error message of a invalid value is shown to a User “Invalid service name”<br>- Given specialization field is completedThen drop-down list must contain services according to the specialization<br>- Given doctor field is completedThen drop-down list must contain services according to the doctor’s specialization<br>- Given office field is completedThen drop-down list must contain services according to the specializations of doctors from the office <br>- Given the service field is empty And the field loses focusThen the border of the field becomes red And an error message of a missing value is shown to a User “Please, choose the service”                                                                                                                                                                                                                                                                                                                          |
| F-5   | Office         | **Required:** yes<br><br>**Type:** dropdown<br><br>**Default value:** empty<br><br>**Behaviour:** <br><br>- When the User selects an office fieldThen the System displays the list of offices in the dropdown<br>- When the User selects the office from dropdownThen the System should fill the office field with this office<br>- Given specialization field is completedThen drop-down list must contain offices that have doctors with such a specialization<br>- Given doctor field is completedThen office field has to be filled with doctor’s office address<br>- Given service field is completedThen drop-down list must contain offices that have doctors with such a specialization<br>- Given the office field is empty And the field loses focusThen the border of the field becomes red And an error message of a missing value is shown to the User “Please, choose the office”                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| F-6   | Date           | See US “Select Date and Time by admin”                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| F-7   | Timeslots      | See US “Select Date and Time by admin”                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

### US-65 Select Date and Time Slot by admin

_As a RECEPTIONIST_
_I want to select time and date of appointment_
_so as I can create an appointment for patient at the appropriate time_

## Preconditions

- User is on the “Create an appointment” modal window
- Specialisation and service fields are completed
...
| ----- | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **#** | **Field name** | **Description**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| F-6   | Date           | **Required:** yes<br><br>**Type:** datepicker<br><br>**Default value:** empty<br><br>**Behaviour:** <br><br>- Given there are no free time slots on the dateThen the System doesn’t allow to pick this date <br>- Given the date field is empty And the field loses focusThen the border of the field becomes red And an error message of a missing value is shown to a User “Please, select the date”                                                                                                                                   |
| F-7   | Timeslots      | **Required:** yes<br><br>**Type:** table of slots<br><br>**Default value:** empty<br><br>**Behaviour:** <br><br>- Given the date is selectedThen free time slots according to the date, the specialisation, the service, the doctor (optional) are displayed<br>- Given the date is not selectedThen time slots are disabled to view<br>- Given the time slot field is empty And the field loses focusThen the border of the field becomes red And an error message of a missing value is shown to a User “Please, select the time slot” |

### US-66 Reschedule appointment

_As a PATIENT_
_I want to reschedule appointment_
*so as I can change time of the appointment if necessary* 

## Preconditions

- Patient is signed in
- Patient is on profile page
- Patient is on page to view appointment history
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **#** | **Description**                                                                                                                                                                                                                                         |
| AC-1  | Only appointments that aren’t approved can be rescheduled                                                                                                                                                                                               |
| AC-2  | When the Patient clicks the button/icon to reschedule the appointment<br><br>Then the modal window to create an appointment with filled fields of this appointment is displayed<br><br>And 2 footer buttons are displayed:<br><br>- Confirm<br>- Cancel |
| AC-3  | Only fields doctor, date, time slot are editable                                                                                                                                                                                                        |
| AC-4  | Given at least one of the fields is empty<br><br>Or at least one of the fields is invalid<br><br>Then the button “Confirm” is disabled                                                                                                                  |
| AC-5  | When a User clicks “Cancel”  button<br><br>Then a dialog window “Do you really want to cancel? Entered data won’t be saved.” is displayed                                                                                                               |
| AC-6  | The dialog window must contain the following buttons:<br><br>- “Yes” button<br>- “No” button                                                                                                                                                            |
| AC-7  | When the User clicks “Yes” button<br><br>Then the dialog window has to be closed<br><br>And the modal window of creation has to be closed                                                                                                               |
| AC-8  | When the User clicks button “No”<br><br>Then the dialog window has to be closed<br><br>And the modal window of creation has to be displayed with already entered fields                                                                                 |
...
| ----- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **#** | **Field name** | **Description**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| F-2   | Doctor         | **Required:** yes<br><br>**Type:** combobox<br><br>**Default value:** empty<br><br>**Behaviour:** <br><br>- When the User starts typing in the doctor's name Or the User clicks on the doctor fieldThen the System displays the filtered result (if available) of doctors in the dropdown<br>- When the User selects the doctor from drop-down listThen the System should fill the doctor field with this doctor<br>- Given entered doctor name doesn’t existAnd the field loses focusThen an error message of a invalid value is shown to a User “Invalid doctor name”<br>- Given specialization field is completedThen drop-down list must contain doctors according to the specialization<br>- Given service field is completedThen drop-down list must contain doctors according to the services<br>- Given office field is completedThen drop-down list must contain doctors according to the the office <br>- Given the doctor field is emptyAnd time and date are completedThen drop-down list must contain doctors according to the selected time and date<br>- Given the doctor field is emptyAnd time and date are completedAnd only 1 doctor is free at this timeThen doctor field is completed with free doctor<br>- Given the doctor field is empty And the field loses focusThen the border of the field becomes red And an error message of a missing value is shown to a User “Please, choose the doctor” |
| F-5   | Date           | **Required:** yes<br><br>**Type:** datepicker<br><br>**Default value:** empty<br><br>**Behaviour:** <br><br>- Given there are no free time slots on the dateThen the date is unable to pick<br>- Given the date field is empty And the field loses focusThen the border of the field becomes red And an error message of a missing value is shown to a User “Please, select the date”                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| F-6   | Timeslots      | **Required:** yes<br><br>**Type:** table of slots<br><br>**Default value:** empty<br><br>**Behaviour:** <br><br>- Given the date is selectedThen free time slots due to the date, the specialisation, the service, the doctor (optional) are displayed<br>- Given the date is not selectedThen time slots are disabled to view<br>- Given the time slot field is empty And the field loses focusThen the border of the field becomes red And an error message of a missing value is shown to a User “Please, select the time slot”                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |

### US-67 Reschedule appointment by admin

_As a RECEPTIONIST_
_I want to reschedule appointment_
*so as I can change time of the patient’s appointment if necessary* 
...
| **#** | **Description**                                                                                                                                                                                                                                              |
| AC-1  | Only appointments that aren’t approved can be rescheduled                                                                                                                                                                                                    |
| AC-2  | When the Receptionist clicks the button/icon to reschedule the appointment<br><br>Then the modal window to create an appointment with filled fields of this appointment is displayed<br><br>And 2 footer buttons are displayed:<br><br>- Confirm<br>- Cancel |
| AC-3  | Only fields doctor, date, time slot are editable                                                                                                                                                                                                             |
| AC-4  | Given at least one of the fields is empty<br><br>Or at least one of the fields is invalid<br><br>Then the button “Confirm” is disabled                                                                                                                       |
| AC-5  | When a User clicks “Cancel”  button<br><br>Then a dialog window “Do you really want to cancel? Entered data won’t be saved.” is displayed                                                                                                                    |
| AC-6  | The dialog window must contain the following buttons:<br><br>- “Yes” button<br>- “No” button                                                                                                                                                                 |
| AC-7  | When the User clicks “Yes”button <br><br>Then the dialog window is closed<br><br>And the modal window of creation is closed                                                                                                                                  |
| AC-8  | When the User clicks “No” button<br><br>Then the dialog window is closed<br><br>And the modal window of creation is displayed with already entered fields                                                                                                    |
...
### US-68 Get appointment result on email

_As a PATIENT_
_I want to get my appointment results on email_
_so as I can get my appointment results without visiting the website and entering my profile_

## Preconditions

- Result for the appointment has been created
...
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **#** | **Description**                                                                                                                                                                                                                     |
| AC-1  | Given the result for the appointment has been created<br><br>Or the result for the appointment has been updated<br><br>Then the file with result information is sent to the email of the patient who is related to this appointment |
| AC-2  | Result information should represent the information filled in the table, that is further converted into a document of  internally approved format                                                                                   |
